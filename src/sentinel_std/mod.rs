    ...
    fn setup(&mut self, _ag: &mut AsyncGroup) -> errs::Result<()> {
        ...
        match pool_cfg {
            RedisPool::StringConfig(boxed_cfg) => {
                ...
                .map_err(|e| {
                    errs::Err::with_source(
                        RedisError::FailToBuildSentinelClientOfAddrs {
                ...
                let pool = pool_builder
                    ...
                    .map_err(|e| {
                        errs::Err::with_source(
                            RedisError::FailToBuildPoolOfAddrs {
                                addrs: cfg.addrs,
            ...
            RedisPool::ConnAddrConfig(boxed_cfg) => {
                ...
                .map_err(|e| {
                    errs::Err::with_source(
                        RedisError::FailToBuildSentinelClientOfConnAddrs {
                ...
                let pool = pool_builder
                    ...
                    .map_err(|e| {
                        errs::Err::with_source(
                            RedisError::FailToBuildPoolOfConnAddrs {
            ...
            RedisPool::ConnInfoConfig(boxed_cfg) => {
                ...
                .map_err(|e| {
                    errs::Err::with_source(
                        RedisError::FailToBuildSentinelClientOfConnInfos {
                ...
                let pool = pool_builder
                    ...
                    .map_err(|e| {
                        errs::Err::with_source(
                            RedisError::FailToBuildPoolOfConnInfos {
            ...
            RedisPool::ClientBuilderConfig(boxed_cfg) => {
                ...
                let client = client_builder.build().map_err(|e| {
                    errs::Err::with_source(
                        RedisError::FailToBuildSentinelClientWithClientBuilder,
                        e,
                    )
                })?;
                let pool = pool_builder
...
mod unit_tests_of_data_src {
    ...
    mod test_new {
        ...
        fn addrs_are_strs_and_fail() {
            ...
            let Ok(RedisError::FailToBuildSentinelClientOfAddrs {
                addrs,
                service_name,
                server_type,
        ...
        fn addrs_are_urls_and_ok() {
            ...
            let mut ds =
                RedisDataSrc::new(&[url0, url1, url2], "mymaster", SentinelServerType::Master);
            let mut ag = AsyncGroup::new();
            if let Err(err) = ds.setup(&mut ag) {
                panic!("{err:?}");
            }
    ...
    mod test_with_node_conn_info {
        ...
        fn addrs_are_strs_and_ok() {
            ...
            let mut ds = RedisDataSrc::with_node_conn_info(
                &[
                    "redis://127.0.0.1:26479",
                    "redis://127.0.0.1:26480",
                    "redis://127.0.0.1:26481",
    ...
    mod test_with_pool_builder {
        ...
        fn addrs_are_strs_and_fail() {
            ...
            let Ok(RedisError::FailToBuildPoolOfAddrs {
                addrs,
                service_name,
                server_type,
            }) = err.reason::<RedisError>()
    ...
    mod test_with_node_conn_info_and_pool_builder {
        ...
        fn addrs_are_strs_and_ok() {
            let pb = Pool::builder().max_size(15);
            let node_conn_info = SentinelNodeConnectionInfo::default();
            let mut ds = RedisDataSrc::with_node_conn_info_and_pool_builder(
                &[
                    "redis://127.0.0.1:26479",
                    "redis://127.0.0.1:26480",
                    "redis://127.0.0.1:26481",
    ...
    mod test_with_conn_addrs {
        ...
        fn ok() {
            ...
            let mut ds = RedisDataSrc::with_conn_addrs(
        ...
        fn fail() {
            let mut ds =
                RedisDataSrc::with_conn_addrs(vec![], "mymaster", SentinelServerType::Master);
            let mut ag = AsyncGroup::new();
            let Err(err) = ds.setup(&mut ag) else {
                panic!();
            };
            let Ok(RedisError::FailToBuildSentinelClientOfConnAddrs {
                conn_addrs,
                service_name,
                server_type,
            }) = err.reason::<RedisError>()
    ...
    mod test_with_conn_addrs_and_node_conn_info {
        ...
        fn ok() {
            ...
            let conn_addr2 = redis::ConnectionAddr::Tcp("127.0.0.1".to_string(), 26481);
            let node_conn_info = SentinelNodeConnectionInfo::default();
            let mut ds = RedisDataSrc::with_conn_addrs_and_node_conn_info(
                vec![conn_addr0, conn_addr1, conn_addr2],
                "mymaster",
                SentinelServerType::Master,
                node_conn_info,
        ...
        fn fail() {
            ...
            let Ok(RedisError::FailToBuildPoolOfConnAddrs {
                conn_addrs,
                service_name,
                server_type,
            }) = err.reason::<RedisError>()
    ...
    mod test_with_conn_addrs_and_node_conn_info_and_pool_builder {
        ...
        fn ok() {
            ...
            let conn_addr2 = redis::ConnectionAddr::Tcp("127.0.0.1".to_string(), 26481);
            let node_conn_info = SentinelNodeConnectionInfo::default();
            let mut ds = RedisDataSrc::with_conn_addrs_and_node_conn_info_and_pool_builder(
                vec![conn_addr0, conn_addr1, conn_addr2],
                "mymaster",
                SentinelServerType::Master,
                node_conn_info,
    ...
    mod test_with_conn_infos {
        ...
        fn ok() {
            ...
            let mut ds = RedisDataSrc::with_conn_infos(
        ...
        fn fail() {
            let mut ds =
                RedisDataSrc::with_conn_infos(vec![], "mymaster", SentinelServerType::Master);
            let mut ag = AsyncGroup::new();
            let Err(err) = ds.setup(&mut ag) else {
                panic!();
            };
            let Ok(RedisError::FailToBuildSentinelClientOfConnInfos {
                conn_infos,
                service_name,
                server_type,
            }) = err.reason::<RedisError>()
    ...
    mod test_with_conn_infos_and_node_conn_info {
        ...
        fn ok() {
            ...
            let conn_info2 = "redis://127.0.0.1:26481/0".into_connection_info().unwrap();
            let node_conn_info = SentinelNodeConnectionInfo::default();
            let mut ds = RedisDataSrc::with_conn_infos_and_node_conn_info(
                vec![conn_info0, conn_info1, conn_info2],
                "mymaster",
                SentinelServerType::Master,
                node_conn_info,
        ...
        fn fail() {
            ...
            let Ok(RedisError::FailToBuildPoolOfConnInfos {
                conn_infos,
                service_name,
                server_type,
            }) = err.reason::<RedisError>()
    ...
    mod test_with_conn_infos_and_node_conn_info_and_pool_builder {
        ...
        fn ok() {
            ...
            let conn_info2 = "redis://127.0.0.1:26481/0".into_connection_info().unwrap();
            let node_conn_info = SentinelNodeConnectionInfo::default();
            let mut ds = RedisDataSrc::with_conn_infos_and_node_conn_info_and_pool_builder(
                vec![conn_info0, conn_info1, conn_info2],
                "mymaster",
                SentinelServerType::Master,
                node_conn_info,
    ...
    mod test_with_client_builder {
        ...
        fn fail() {
            ...
            let Ok(RedisError::FailToBuildSentinelClientWithClientBuilder) =
                err.reason::<RedisError>()
            else {
                panic!();
            };
