...
mod unit_tests_of_data_src {
    ...
    mod test_with_conn_addrs {
        ...
        fn fail() {
            ...
            assert_eq!(addrs, &[] as &[redis::ConnectionAddr]);
            assert_eq!(service_name, "mymaster");
            assert_eq!(format!("{:?}", server_type), "Master");
            assert_eq!(
                format!("{:?}", err.source().unwrap()),
    ...
    mod test_with_conn_addrs_and_node_conn_info {
        ...
        fn fail() {
            ...
            assert_eq!(addrs, &[conn_addr0, conn_addr1, conn_addr2]);
            assert_eq!(service_name, "mymaster");
            assert_eq!(format!("{:?}", server_type), "Master");
            assert_eq!(
                format!("{:?}", err.source().unwrap()),
    ...
    mod test_with_conn_infos_and_node_conn_info {
        ...
        fn fail() {
            ...
            assert_eq!(addrs[0].addr(), conn_info0.addr());
            assert_eq!(addrs[1].addr(), conn_info1.addr());
            assert_eq!(addrs[2].addr(), conn_info2.addr());
            assert_eq!(service_name, "mymaster");
            assert_eq!(format!("{:?}", server_type), "Master");
            assert_eq!(
                format!("{:?}", err.source().unwrap()),
