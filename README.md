...
```toml
[dependencies]
sabi_redis = "0.8.0" # `standalone` feature is enabled by default.

# If you want to use the `standalone-async` feature:
# sabi_redis = { version = "0.8.0", default-features = false, features = ["standalone-async"] }

# If you want to use the `sentinel` feature:
# sabi_redis = { version = "0.8.0", default-features = false, features = ["sentinel"] }

# If you want to use the `sentinel-async` feature:
# sabi_redis = { version = "0.8.0", default-features = false, features = ["sentinel-async"] }

# If you want to use the `cluster` feature:
# sabi_redis = { version = "0.8.0", default-features = false, features = ["cluster"] }

# If you want to use the `cluster-async` feature:
# sabi_redis = { version = "0.8.0", default-features = false, features = ["cluster-async"] }
```
