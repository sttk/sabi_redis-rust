...
```toml
[dependencies]
sabi_redis = "0.4.0" # `standalone-sync` feature is enabled by default.

# If you want to use the `standalone-async` feature:
# sabi_redis = { version = "0.4.0", default-features = false, features = ["standalone-async"] }

# If you want to use the `sentinel-sync` feature:
# sabi_redis = { version = "0.4.0", default-features = false, features = ["sentinel-sync"] }

# If you want to use the `sentinel-async` feature:
# sabi_redis = { version = "0.4.0", default-features = false, features = ["sentinel-async"] }

# If you want to use the `cluster-sync` feature:
# sabi_redis = { version = "0.4.0", default-features = false, features = ["cluster-sync"] }

# If you want to use the `cluster-async` feature:
# sabi_redis = { version = "0.4.0", default-features = false, features = ["cluster-async"] }
```
